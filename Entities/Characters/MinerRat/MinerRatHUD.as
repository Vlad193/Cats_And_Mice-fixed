...
void onRender(CSprite@ this)
{
	...
	double cooldownMiningSecs = (diff / 30) * (-1);
	int cooldownMiningFullSecs = diff % 30;
	...
	else
	{
		...
		GUI::SetFont("menu"); GUI::DrawText("" + cooldownMiningSecs + "  R button", Vec2f(25,175), SColor(255, 255, 216, 0));
	}
}
