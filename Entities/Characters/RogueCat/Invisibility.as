...
{	
	if (this.get_u32("invisible") > 10*30)
	{
		this.set_u32("invisible", 10*30 - 5); // checks if invisibility gone endless and sets it back to last ticks
	}
